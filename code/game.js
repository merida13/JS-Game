...
function Tar(pos, ch) {
  ...
  if (ch == "=") {
    ...
    // Drip tar. Repeat back to this pos.
    this.speed = new Vector(0, 3);
    this.repeatPos = pos;
  }
}
Tar.prototype.type = "tar";
...
Tar.prototype.act = function(step, level) {
...
var wobbleESpeed = 2, wobbleEDist = 2;
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  // Handle tar by calling playerTouched
  if (obstacle)
